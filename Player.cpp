...
Player::Player(bool rightSide, Player* enemy, FMOD::System* system)
{
	...
	if (rightSide)
	{
		character = new Character(0, glm::vec3(getCellCenter(996), 0.0f, getCellCenter(930)), system);
	...
	{
		character = new Character(0, glm::vec3(getCellCenter(1052), 0.0f, getCellCenter(1118)), system);
